...
class SocialMedia {
    ...
    public static function GetSocialMediaSites_WithShareLinks_OrderedByAlphabet() {
        $nice_names = self::GetSocialMediaSites_NiceNames();
    ...
    public static function GetSocialMediaSiteLinks_WithShareLinks( $args ) {
        $default = [
            'url' => '',
            'title' => '',
            'image' => '',
